  ...
  async (payload, thunkAPI) => {
    try {
      ...
      const res = await axios.get(
        `https://helpus-api.shop/api/post/all-location`
      );
...
export const __getHelpeeFalse = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    try {
      ...
      const res = await axios.get(
        `https://helpus-api.shop/api/post/all-location?category=1/`
      );
...
export const __getHelperFalse = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    try {
      ...
      const res = await axios.get(
        `https://helpus-api.shop/api/post/all-location?category=2`
      );
...
export const __getHelpUsFalse = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    try {
      ...
      const res = await axios.get(
        `https://helpus-api.shop/api/post/all-location?category=3`
      );
...
export const __searchFalse = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    try {
      ...
      // const res = PostAPI.getSearch(payload);
      const res = await axios.get(
        `https://helpus-api.shop/api/post/all-location?categoty=&search=${payload}`
      );
      console.log("search res:", res);
      return thunkAPI.fulfillWithValue(res.data);
    } catch (err) {
...
export const __getHelpeeTrue = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    try {
      ...
      const res = await axios.get(
        `https://helpus-api.shop/api/post/my-location?category=1`,
        { headers: { Authorization: `Bearer ${cookie.get("token")}` } }
      );
...
export const __getHelperTrue = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    try {
      ...
      const res = await axios.get(
        `https://helpus-api.shop/api/post/my-location?category=2`,
        { headers: { Authorization: `Bearer ${cookie.get("token")}` } }
      );
...
export const __getHelpUsTrue = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    try {
      ...
      const res = await axios.get(
        `https://helpus-api.shop/api/post/my-location?category=3`,
        { headers: { Authorization: `Bearer ${cookie.get("token")}` } }
      );
      // headers.authorization = `Bearer ${cookie.get("token")}`
...
const postSlice = createSlice({
  ...
  extraReducers: {
    ...
    [__searchFalse.fulfilled]: (state, action) => {
      state.searchFalse = action.payload;
      state.searched = true;
      console.log("search false 가져오기 fulfilled 성공");
    },
    [__searchFalse.rejected]: (state, action) => {
      console.log("search false 가져오기 Error");
    },
    ...
    [__getAllTrue.fulfilled]: (state, action) => {
      ...
      console.log("전체 true 가져오기 fulfilled 성공");
    },
    ...
    [__getHelpeeTrue.fulfilled]: (state, action) => {
      ...
      console.log("헬피 true 가져오기 fulfilled 성공");
    },
    ...
    [__getHelperTrue.fulfilled]: (state, action) => {
      ...
      console.log("헬퍼 true 가져오기 fulfilled 성공");
    },
    ...
    [__searchTrue.fulfilled]: (state, action) => {
      state.searchTrue = action.payload;
      state.searched = true;
      console.log("search true 가져오기 fulfilled 성공");
    },
    [__searchTrue.rejected]: (state, action) => {
      console.log("search true 가져오기 Error");
    },
  },
});
export const {
